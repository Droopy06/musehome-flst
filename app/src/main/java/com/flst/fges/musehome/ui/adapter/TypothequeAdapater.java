...
public class TypothequeAdapater extends RecyclerView.Adapter<TypothequeAdapater.ViewHolder>  {

    private ArrayList<Typotheque> typotheques;
    private Context context;

    public TypothequeAdapater(ArrayList<Typotheque> typotheques, Context context) {
        this.typotheques = typotheques;
        this.context = context;
    }

    @Override
    public TypothequeAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TypothequeAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(typotheques.get(position).getName());
        Picasso.with(context).load(typotheques.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return typotheques.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Typotheque");
