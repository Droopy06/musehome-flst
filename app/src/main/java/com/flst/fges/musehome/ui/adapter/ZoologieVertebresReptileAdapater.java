...
public class ZoologieVertebresReptileAdapater extends RecyclerView.Adapter<ZoologieVertebresReptileAdapater.ViewHolder>  {

    private ArrayList<ZoologieVertebresReptile> zoologieVertebresReptiles;
    private Context context;

    public ZoologieVertebresReptileAdapater(ArrayList<ZoologieVertebresReptile> zoologieVertebresReptiles, Context context) {
        this.zoologieVertebresReptiles = zoologieVertebresReptiles;
        this.context = context;
    }

    @Override
    public ZoologieVertebresReptileAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ZoologieVertebresReptileAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(zoologieVertebresReptiles.get(position).getName());
        Picasso.with(context).load(zoologieVertebresReptiles.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return zoologieVertebresReptiles.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Zoologie Vertebres Reptile");
