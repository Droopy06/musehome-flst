...
public class ZoologieInvertebresMollusquesAdapater extends RecyclerView.Adapter<ZoologieInvertebresMollusquesAdapater.ViewHolder>  {

    private ArrayList<ZoologieInvertebresMollusques> zoologieInvertebresMollusques;
    private Context context;

    public ZoologieInvertebresMollusquesAdapater(ArrayList<ZoologieInvertebresMollusques> zoologieInvertebresMollusques, Context context) {
        this.zoologieInvertebresMollusques = zoologieInvertebresMollusques;
        this.context = context;
    }

    @Override
    public ZoologieInvertebresMollusquesAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ZoologieInvertebresMollusquesAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(zoologieInvertebresMollusques.get(position).getName());
        Picasso.with(context).load(zoologieInvertebresMollusques.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return zoologieInvertebresMollusques.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Zoologie Invertebres Mollusques");
