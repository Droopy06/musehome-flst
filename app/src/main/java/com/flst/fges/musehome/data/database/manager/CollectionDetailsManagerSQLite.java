...
/**
 * Created by Olive on 06/03/2017.
 */
...
public class CollectionDetailsManagerSQLite {
    ...
    private static String TABLE_NAME = "collection_details";
    ...
    // Constructeur
    public CollectionDetailsManagerSQLite(Context context) {
    ...
    public long addElementCollection(CollectionDetails collection) {
        // Ajout d'un enregistrement dans la table

        ContentValues values = new ContentValues();
        values.put(KEY_ID, collection.getId());
        values.put(KEY_COLLECTION, collection.getNameOfCollection());
    ...
    public int updateElementCollection(CollectionDetails collection) {
    ...
    public int deleteElementCollection(CollectionDetails collection) {
    ...
    public CollectionDetails getElementCollectionById(String id) {
        ...
        if (c.moveToFirst()) {
            ...
            collection.setNameOfCollection(c.getString(c.getColumnIndex(KEY_COLLECTION)));
    ...
    public ArrayList<CollectionDetails> getAllElementCollections() {
        ArrayList<CollectionDetails> collections = new ArrayList<>();
