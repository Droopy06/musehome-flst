...
public class OuvragesCartesDocumentsAdapater extends RecyclerView.Adapter<OuvragesCartesDocumentsAdapater.ViewHolder>  {

    private ArrayList<OuvragesCartesDocuments> ouvragesCartesDocumentses;
    private Context context;

    public OuvragesCartesDocumentsAdapater(ArrayList<OuvragesCartesDocuments> ouvragesCartesDocumentses, Context context) {
        this.ouvragesCartesDocumentses = ouvragesCartesDocumentses;
        this.context = context;
    }

    @Override
    public OuvragesCartesDocumentsAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OuvragesCartesDocumentsAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(ouvragesCartesDocumentses.get(position).getName());
        Picasso.with(context).load(ouvragesCartesDocumentses.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return ouvragesCartesDocumentses.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Ouvrages Cartes Documents");
