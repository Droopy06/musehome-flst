...
public class ZoologieInvertebresAutresAdapater extends RecyclerView.Adapter<ZoologieInvertebresAutresAdapater.ViewHolder>  {

    private ArrayList<ZoologieInvertebresAutres> zoologieInvertebresAutres;
    private Context context;

    public ZoologieInvertebresAutresAdapater(ArrayList<ZoologieInvertebresAutres> zoologieInvertebresAutres, Context context) {
        this.zoologieInvertebresAutres = zoologieInvertebresAutres;
        this.context = context;
    }

    @Override
    public ZoologieInvertebresAutresAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ZoologieInvertebresAutresAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(zoologieInvertebresAutres.get(position).getName());
        Picasso.with(context).load(zoologieInvertebresAutres.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return zoologieInvertebresAutres.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Zoologie Invertebres Autres");
