...
public class PhysiqueAdapater extends RecyclerView.Adapter<PhysiqueAdapater.ViewHolder>  {

    private ArrayList<Physique> physiques;
    private Context context;

    public PhysiqueAdapater(ArrayList<Physique> physiques, Context context) {
        this.physiques = physiques;
        this.context = context;
    }

    @Override
    public PhysiqueAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PhysiqueAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(physiques.get(position).getName());
        Picasso.with(context).load(physiques.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return physiques.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Physique");
