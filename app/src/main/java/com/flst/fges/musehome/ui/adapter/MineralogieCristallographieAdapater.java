...
public class MineralogieCristallographieAdapater extends RecyclerView.Adapter<MineralogieCristallographieAdapater.ViewHolder>  {

    private ArrayList<MineralogieCristallographie> mineralogieCristallographies;
    private Context context;

    public MineralogieCristallographieAdapater(ArrayList<MineralogieCristallographie> mineralogieCristallographies, Context context) {
        this.mineralogieCristallographies = mineralogieCristallographies;
        this.context = context;
    }

    @Override
    public MineralogieCristallographieAdapater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MineralogieCristallographieAdapater.ViewHolder holder, int position) {
        holder.objectCollectionTxt.setText(mineralogieCristallographies.get(position).getName());
        Picasso.with(context).load(mineralogieCristallographies.get(position).getPicture()).into(holder.objectCollectionImagageView);
    }

    @Override
    public int getItemCount() {
        return mineralogieCristallographies.size();
    }
        ...
        ViewHolder(final View itemView) {
            ...
            objectcollectionCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("COLLECTION","Mineralogie Cristallographie");
